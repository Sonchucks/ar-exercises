...
@store1.employees.create(first_name: "David", last_name: "Son", hourly_rate: 60)
@store1.employees.create(first_name: "Zach", last_name: "Lee", hourly_rate: 60)
@store2.employees.create(first_name: "John", last_name: "Xu", hourly_rate: 80)
@store2.employees.create(first_name: "Shawn", last_name: "Levasseur", hourly_rate: 85)
@store2.employees.create(first_name: "Louis", last_name: "Riehl", hourly_rate: 70)